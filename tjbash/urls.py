...
urlpatterns = [
    ...
    url(r'^quotes/delete/(?P<qid>\d+)/$', views.delete_quote, name="delete_quote"),
    url(r'^quotes/edit/(?P<qid>\d+)/', views.edit_quote, name="edit_quote"),
    url(r'^quotes/upvote/(?P<qid>\d+)/', views.upvote_quote, name="upvote_quote"),
    url(r'^quotes/downvote/(?P<qid>\d+)/', views.downvote_quote, name="downvote_quote"),
